...
class Lab < ApplicationRecord
  ...
  after_commit :create_initial_invite_codes
  def create_initial_invite_codes
  ...
  protected
    ...
    before_create :create_first_user_and_update_name
    def create_first_user_and_update_name
